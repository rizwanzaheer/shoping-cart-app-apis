...
describe('User routes', () => {
  describe('POST /v1/users', () => {
    ...
    test('should return 403 error if logged in user is not admin', async () => {
      ...
      await request(app).post('/v1/users').send(newUser).expect(httpStatus.FORBIDDEN);
    });
  ...
  describe('GET /v1/users', () => {
    ...
    test('should return 403 if a non-admin is trying to access all users', async () => {
      ...
      await request(app).get('/v1/users').send().expect(httpStatus.FORBIDDEN);
    });
    ...
    test('should correctly sort the returned array if ascending sort param is specified', async () => {
      ...
      const res = await request(app).get('/v1/users').query({ sortBy: 'role:asc' }).send().expect(httpStatus.OK);
  ...
  describe('GET /v1/users/:userId', () => {
    ...
    test('should return 403 error if user is trying to get another user', async () => {
      ...
      await request(app).get(`/v1/users/${userTwo._id}`).send().expect(httpStatus.FORBIDDEN);
    });
  ...
  describe('DELETE /v1/users/:userId', () => {
    ...
    test('should return 403 error if user is trying to delete another user', async () => {
      ...
      await request(app).delete(`/v1/users/${userTwo._id}`).send().expect(httpStatus.FORBIDDEN);
    });
  ...
  describe('PATCH /v1/users/:userId', () => {
    ...
    test('should return 403 if user is updating another user', async () => {
      ...
      await request(app).patch(`/v1/users/${userTwo._id}`).send(updateBody).expect(httpStatus.FORBIDDEN);
    });
